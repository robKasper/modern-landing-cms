      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
          {steps.map((step, index) => (
            ...
            >
              <div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-2xl font-bold mb-6 mx-auto glow-primary-sm">
                {step.number}
              </div>
              <h3 className="text-xl font-semibold mb-4 font-display">{step.title}</h3>
